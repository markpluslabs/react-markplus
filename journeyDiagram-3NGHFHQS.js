...
`,"getStyles"),v=/* @__PURE__ */(0,s.__name)(function(t,e){return(0,n.drawRect)(t,e)},"drawRect"),$=/* @__PURE__ */(0,s.__name)(function(t,e){let a=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),i=t.append("g");function n(t){let a=(0,r.arc_default)().startAngle(Math.PI/2).endAngle(Math.PI/2*3).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",a).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}function l(t){let a=(0,r.arc_default)().startAngle(3*Math.PI/2).endAngle(Math.PI/2*5).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",a).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}function o(t){t.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return i.append("circle").attr("cx",e.cx-5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),i.append("circle").attr("cx",e.cx+5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),(0,s.__name)(n,"smile"),(0,s.__name)(l,"sad"),(0,s.__name)(o,"ambivalent"),e.score>3?n(i):e.score<3?l(i):o(i),a},"drawFace"),T=/* @__PURE__ */(0,s.__name)(function(t,e){let a=t.append("circle");return a.attr("cx",e.cx),a.attr("cy",e.cy),a.attr("class","actor-"+e.pos),a.attr("fill",e.fill),a.attr("stroke",e.stroke),a.attr("r",e.r),void 0!==a.class&&a.attr("class",a.class),void 0!==e.title&&a.append("title").text(e.title),a},"drawCircle"),M=/* @__PURE__ */(0,s.__name)(function(t,e){return(0,n.drawText)(t,e)},"drawText"),S=/* @__PURE__ */(0,s.__name)(function(t,e,a){let i=t.append("g"),r=(0,n.getNoteRect)();r.x=e.x,r.y=e.y,r.fill=e.fill,r.width=a.width*e.taskCount+a.diagramMarginX*(e.taskCount-1),r.height=a.height,r.class="journey-section section-type-"+e.num,r.rx=3,r.ry=3,v(i,r),C(a)(e.text,i,r.x,r.y,r.width,r.height,{class:"journey-section section-type-"+e.num},a,e.colour)},"drawSection"),A=-1,E=/* @__PURE__ */(0,s.__name)(function(t,e,a){let i=e.x+a.width/2,r=t.append("g");A++,r.append("line").attr("id","task"+A).attr("x1",i).attr("y1",e.y).attr("x2",i).attr("y2",450).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),$(r,{cx:i,cy:300+(5-e.score)*30,score:e.score});let s=(0,n.getNoteRect)();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=a.width,s.height=a.height,s.class="task task-type-"+e.num,s.rx=3,s.ry=3,v(r,s);let l=e.x+14;e.people.forEach(t=>{let a=e.actors[t].color;T(r,{cx:l,cy:e.y,r:7,fill:a,stroke:"#000",title:t,pos:e.actors[t].position}),l+=10}),C(a)(e.task,r,s.x,s.y,s.width,s.height,{class:"task"},a,e.colour)},"drawTask"),C=/* @__PURE__ */function(){function t(t,e,a,n,r,s,l,o){i(e.append("text").attr("x",a+r/2).attr("y",n+s/2+5).style("font-color",o).style("text-anchor","middle").text(t),l)}function e(t,e,a,n,r,s,l,o,c){let{taskFontSize:h,taskFontFamily:u}=o,y=t.split(/<br\s*\/?>/gi);for(let t=0;t<y.length;t++){let o=t*h-h*(y.length-1)/2,p=e.append("text").attr("x",a+r/2).attr("y",n).attr("fill",c).style("text-anchor","middle").style("font-size",h).style("font-family",u);p.append("tspan").attr("x",a+r/2).attr("dy",o).text(y[t]),p.attr("y",n+s/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),i(p,l)}}function a(t,a,n,r,s,l,o,c){let h=a.append("switch"),u=h.append("foreignObject").attr("x",n).attr("y",r).attr("width",s).attr("height",l).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");u.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(t),e(t,h,n,r,s,l,o,c),i(u,o)}function i(t,e){for(let a in e)a in e&&t.attr(a,e[a])}return(0,s.__name)(t,"byText"),(0,s.__name)(e,"byTspan"),(0,s.__name)(a,"byFo"),(0,s.__name)(i,"_setTextAttrs"),function(i){return"fo"===i.textPlacement?a:"old"===i.textPlacement?t:e}}(),I={drawCircle:T,drawSection:S,drawText:M,drawTask:E,initGraphics:/* @__PURE__ */(0,s.__name)(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics")},P=/* @__PURE__ */(0,s.__name)(function(t){Object.keys(t).forEach(function(e){V[e]=t[e]})},"setConf"),j={};function R(t){let e=(0,r.getConfig2)().journey,a=60;Object.keys(j).forEach(i=>{let n=j[i].color,r={cx:20,cy:a,r:7,fill:n,stroke:"#000",pos:j[i].position};I.drawCircle(t,r);let s={x:40,y:a+7,fill:"#666",text:i,textMargin:5|e.boxTextMargin};I.drawText(t,s),a+=20})}(0,s.__name)(R,"drawActorLegend");var V=(0,r.getConfig2)().journey,D=V.leftMargin,O=/* @__PURE__ */(0,s.__name)(function(t,e,a,i){let n;let s=(0,r.getConfig2)().journey,l=(0,r.getConfig2)().securityLevel;"sandbox"===l&&(n=(0,r.select_default)("#i"+e));let o="sandbox"===l?(0,r.select_default)(n.nodes()[0].contentDocument.body):(0,r.select_default)("body");F.init();let c=o.select("#"+e);I.initGraphics(c);let h=i.db.getTasks(),u=i.db.getDiagramTitle(),y=i.db.getActors();for(let t in j)delete j[t];let p=0;y.forEach(t=>{j[t]={color:s.actorColours[p%s.actorColours.length],position:p},p++}),R(c),F.insert(0,0,D,50*Object.keys(j).length),L(c,h,0);let d=F.getBounds();u&&c.append("text").text(u).attr("x",D).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);let _=d.stopy-d.starty+2*s.diagramMarginY,f=D+d.stopx+2*s.diagramMarginX;(0,r.configureSvgSize)(c,_,f,s.useMaxWidth),c.append("line").attr("x1",D).attr("y1",4*s.height).attr("x2",f-D-4).attr("y2",4*s.height).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let m=u?70:0;c.attr("viewBox",`${d.startx} -25 ${f} ${_+m}`),c.attr("preserveAspectRatio","xMinYMin meet"),c.attr("height",_+m+25)},"draw"),F={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:/* @__PURE__ */(0,s.__name)(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:/* @__PURE__ */(0,s.__name)(function(t,e,a,i){void 0===t[e]?t[e]=a:t[e]=i(a,t[e])},"updateVal"),updateBounds:/* @__PURE__ */(0,s.__name)(function(t,e,a,i){let n=(0,r.getConfig2)().journey,l=this,o=0;function c(r){return/* @__PURE__ */(0,s.__name)(function(s){o++;let c=l.sequenceItems.length-o+1;l.updateVal(s,"starty",e-c*n.boxMargin,Math.min),l.updateVal(s,"stopy",i+c*n.boxMargin,Math.max),l.updateVal(F.data,"startx",t-c*n.boxMargin,Math.min),l.updateVal(F.data,"stopx",a+c*n.boxMargin,Math.max),"activation"!==r&&(l.updateVal(s,"startx",t-c*n.boxMargin,Math.min),l.updateVal(s,"stopx",a+c*n.boxMargin,Math.max),l.updateVal(F.data,"starty",e-c*n.boxMargin,Math.min),l.updateVal(F.data,"stopy",i+c*n.boxMargin,Math.max))},"updateItemBounds")}(0,s.__name)(c,"updateFn"),this.sequenceItems.forEach(c())},"updateBounds"),insert:/* @__PURE__ */(0,s.__name)(function(t,e,a,i){let n=Math.min(t,a),r=Math.max(t,a),s=Math.min(e,i),l=Math.max(e,i);this.updateVal(F.data,"startx",n,Math.min),this.updateVal(F.data,"starty",s,Math.min),this.updateVal(F.data,"stopx",r,Math.max),this.updateVal(F.data,"stopy",l,Math.max),this.updateBounds(n,s,r,l)},"insert"),bumpVerticalPos:/* @__PURE__ */(0,s.__name)(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:/* @__PURE__ */(0,s.__name)(function(){return this.verticalPos},"getVerticalPos"),getBounds:/* @__PURE__ */(0,s.__name)(function(){return this.data},"getBounds")},N=V.sectionFills,B=V.sectionColours,L=/* @__PURE__ */(0,s.__name)(function(t,e,a){let i=(0,r.getConfig2)().journey,n="",s=a+(2*i.height+i.diagramMarginY),l=0,o="#CCC",c="black",h=0;for(let[a,r]of e.entries()){if(n!==r.section){o=N[l%N.length],h=l%N.length,c=B[l%B.length];let s=0,u=r.section;for(let t=a;t<e.length&&e[t].section==u;t++)s+=1;let y={x:a*i.taskMargin+a*i.width+D,y:50,text:r.section,fill:o,num:h,colour:c,taskCount:s};I.drawSection(t,y,i),n=r.section,l++}let u=r.people.reduce((t,e)=>(j[e]&&(t[e]=j[e]),t),{});r.x=a*i.taskMargin+a*i.width+D,r.y=s,r.width=i.diagramMarginX,r.height=i.diagramMarginY,r.colour=c,r.fill=o,r.num=h,r.actors=u,I.drawTask(t,r,i),F.insert(r.x,r.y,r.x+r.width+i.taskMargin,450)}},"drawTasks"),z={setConf:P,draw:O},X={parser:l,db:b,renderer:z,styles:w,init:/* @__PURE__ */(0,s.__name)(t=>{z.setConf(t.journey),b.clear()},"init")}}),a("12AzM",function(a,i){t(a.exports,"drawRect",()=>o),t(a.exports,"drawBackgroundRect",()=>c),t(a.exports,"drawText",()=>h),t(a.exports,"drawImage",()=>u),t(a.exports,"drawEmbeddedImage",()=>y),t(a.exports,"getNoteRect",()=>p),t(a.exports,"getTextObj",()=>d);var n=e("dX0JM"),r=e("fPryt"),s=e("6FYXn"),l=(0,s.__toESM)((0,n.require_dist)(),1),o=/* @__PURE__ */(0,s.__name)((t,e)=>{let a=t.append("rect");if(a.attr("x",e.x),a.attr("y",e.y),a.attr("fill",e.fill),a.attr("stroke",e.stroke),a.attr("width",e.width),a.attr("height",e.height),e.name&&a.attr("name",e.name),e.rx&&a.attr("rx",e.rx),e.ry&&a.attr("ry",e.ry),void 0!==e.attrs)for(let t in e.attrs)a.attr(t,e.attrs[t]);return e.class&&a.attr("class",e.class),a},"drawRect"),c=/* @__PURE__ */(0,s.__name)((t,e)=>{o(t,{x:e.startx,y:e.starty,width:e.stopx-e.startx,height:e.stopy-e.starty,fill:e.fill,stroke:e.stroke,class:"rect"}).lower()},"drawBackgroundRect"),h=/* @__PURE__ */(0,s.__name)((t,e)=>{let a=e.text.replace(r.lineBreakRegex," "),i=t.append("text");i.attr("x",e.x),i.attr("y",e.y),i.attr("class","legend"),i.style("text-anchor",e.anchor),e.class&&i.attr("class",e.class);let n=i.append("tspan");return n.attr("x",e.x+2*e.textMargin),n.text(a),i},"drawText"),u=/* @__PURE__ */(0,s.__name)((t,e,a,i)=>{let n=t.append("image");n.attr("x",e),n.attr("y",a);let r=(0,l.sanitizeUrl)(i);n.attr("xlink:href",r)},"drawImage"),y=/* @__PURE__ */(0,s.__name)((t,e,a,i)=>{let n=t.append("use");n.attr("x",e),n.attr("y",a);let r=(0,l.sanitizeUrl)(i);n.attr("xlink:href",`#${r}`)},"drawEmbeddedImage"),p=/* @__PURE__ */(0,s.__name)(()=>({x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}),"getNoteRect"),d=/* @__PURE__ */(0,s.__name)(()=>({x:0,y:0,width:100,height:100,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0}),"getTextObj")});